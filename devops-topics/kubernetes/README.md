...
> Summary: Interview-ready concise notes for SRE/Platform engineers — conceptual overviews, copy-paste examples, troubleshooting steps, and short interview Q&A.
>
> How to use: skim the headings for topics to review, test examples in a sandbox cluster, and use the INDEX in the repo for related topics and exercises.
